...
@Config
@Autonomous(name = "BlueAutowGate", group = "LC")
public class BlueAutowgate extends LinearOpMode{
    ...
    public void runOpMode() throws InterruptedException {
        Pose2d initialPose = new Pose2d(-65, -40, Math.toRadians(270));
        ...
        Action IntakeRow1 = drive.actionBuilder(new Pose2d(-15, -25, Math.toRadians(270)))
...
//                .turn(Math.toRadians(-45))
        ...
        Action leave = drive.actionBuilder(new Pose2d(-30, -15, Math.toRadians(270)))
                .setTangent(Math.toRadians(0))
                .splineToConstantHeading(new Vector2d(0, -40), Math.PI / 2)
                .build();

        Action IntakeFromGate = drive.actionBuilder(new Pose2d(-10, -10, Math.toRadians(270)))
                .setTangent(20)
                .splineTo(new Vector2d(10, -58), Math.toRadians(100))

                .build();

        Action IntakeRowThree = drive.actionBuilder(new Pose2d(-10, -10, Math.toRadians(270)))
                .splineToConstantHeading(new Vector2d(36, -48), -Math.PI / 2)
                .build();

        Action ComebackToShootRowThree = drive.actionBuilder(new Pose2d(36, -48, Math.toRadians(270)))
