...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1252.6392322182926; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2081.53871535999; // x position of the perpendicular encoder (in tick units)
    }
