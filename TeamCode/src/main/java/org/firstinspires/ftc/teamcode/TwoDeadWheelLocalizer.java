...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1207.967485989793; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -2070.3160409514176; // x position of the perpendicular encoder (in tick units)
    }
